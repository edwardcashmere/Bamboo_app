defmodule BambooAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BambooAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BambooAppWeb.Gettext, "errors", msg, opts)
    end
  end
